# Causal Jurisdiction Carrier Discriminator RC0 — Preregistration
...
No Contract C mutation is tested in RC0.
...
`SUPPORTED_EXTERNALLY_BOUND_CAUSAL_JURISDICTION_CARRIER_RC0` requires:

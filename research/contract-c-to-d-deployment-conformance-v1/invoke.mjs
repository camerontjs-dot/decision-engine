...
try {
  ...
  const contractCBytes = readFileSync(args["contract-c"]);
  const expectedContractB = readJson(args["expected-contract-b"]);
  const decisionContext = readJson(args["decision-context"]);
